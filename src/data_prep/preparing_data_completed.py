"""
Data preparation for the drought classifier  (COMPLETED copy of preparing_data.py).
...
def build_weekly_master(verbose=0, save_path=None):
    ...
    master = (usdm.merge(weekly_precip, on="week_start", how="left")
